...
INSERT INTO Department (name, description) VALUES
    ('Cardiology', 'This department specializes in the diagnosis, treatment, and management of conditions related to the heart and cardiovascular system. This may include issues such as heart disease, heart attacks, arrhythmias, and heart failure. Cardiologists use various diagnostic tools and techniques to assess heart health, prescribe medications, and provide lifestyle recommendations to prevent and manage heart-related conditions.'),
    ('Dermatology', 'This department deals with the diagnosis and treatment of conditions related to the skin, hair, and nails. Dermatologists may provide medical and surgical interventions for skin conditions such as acne, eczema, psoriasis, skin infections, and skin cancer. They may also offer cosmetic procedures for improving the appearance of the skin.'),
    ('Neurology', 'This department specializes in the diagnosis and treatment of conditions related to the nervous system, including the brain, spinal cord, and peripheral nerves. Neurologists may diagnose and manage conditions such as epilepsy, stroke, multiple sclerosis, Parkinsons disease, and headaches. They may use imaging studies, electrodiagnostic tests, and other techniques to evaluate and treat neurological disorders.'),
    ('Psychology', 'This department focuses on the assessment, diagnosis, and treatment of mental health conditions and emotional well-being. Psychologists may provide therapy, counseling, and behavioral interventions for individuals with mental health issues such as anxiety, depression, stress, and addiction. They may also offer psychological assessments and evaluations for various purposes, such as personality assessment, cognitive testing, and forensic evaluations.'),
    ('Pediatrics', 'This department specializes in the medical care of infants, children, and adolescents. Pediatricians provide preventive care, diagnose and treat illnesses, and monitor the growth and development of young patients. They may address a wide range of health concerns, including common childhood illnesses, vaccinations, developmental delays, and behavioral issues.'),
    ('Otorhinolaryngology', 'This department deals with the diagnosis and treatment of conditions related to the ear, nose, and throat. Otorhinolaryngologists may provide medical and surgical interventions for issues such as ear infections, sinusitis, hearing loss, tonsillitis, and voice disorders. They may also offer cosmetic and reconstructive procedures for facial and neck structures.'),
    ('Ophthalmology', 'This department focuses on the diagnosis and treatment of conditions related to the eyes and vision. Ophthalmologists may provide medical and surgical interventions for eye conditions such as cataracts, glaucoma, diabetic retinopathy, and macular degeneration. They may also perform eye exams, prescribe corrective lenses, and offer refractive surgeries for vision correction.'),
    ('General and Family Medicine', 'This department provides comprehensive primary care services for individuals of all ages, including preventive care, health screenings, and management of acute and chronic medical conditions. General and family practitioners may diagnose and treat a wide range of health issues, offer health promotion and disease prevention guidance, and coordinate care with other specialists as needed.');
