const filter_department_button = document.getElementById('DepartmentFilterButtonAdmin');
...
const filter_section_Departments = document.querySelector('#DepartmentFilterAdmin');
filter_section_Departments.appendChild(filterDepartment);
let displayDepartments = false;
let departments;

const filter_status_button = document.getElementById('StatusFilterButtonAdmin');
const filterStatus = document.createElement('ul');
filterStatus.classList.add("FilterListStatus");
filterDepartment.style.display="none";
const filter_section_Status = document.querySelector('#StatusFilterAdmin');
filter_section_Status.appendChild(filterStatus);
let displayStatus = false;
let statuses;

const order_date_button = document.getElementById("DateFilterButtonAdmin");
let date_order = 0;
let image = document.querySelector('#DateFilterButtonAdmin img');
order_date_button.appendChild(image);

const order_priority_button = document.getElementById("PriorityFilterButtonAdmin");
let priority_order = 0;
let image_priority = document.querySelector('#PriorityFilterButtonAdmin img');
...
filter_department_button.addEventListener('click', async function () {
    const response = await fetch('../api/api_getAllDepartments.php');
